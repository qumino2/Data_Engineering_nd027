...
artist_table_insert = ("""INSERT INTO artists (artist_id, name, location, lattitude, longitude) VALUES (%s, %s, %s, %s, %s)                     ON CONFLICT (location) DO UPDATE   
                        ON CONFLICT (lattitude) DO UPDATE
                        ON CONFLICT (longitude) DO UPDATE
""")
